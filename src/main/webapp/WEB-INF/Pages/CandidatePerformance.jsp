...
<div style="padding-top: 5px; padding-bottom: 5px; padding-left: 15px; padding-right: 15px; background: #2178BD; text-align: center; color: white; border-radius: 5px; display: flex; justify-content: center; align-items: center; margin-right: 20px">Download</div>
</div>
    ...
    try {
        ...
        tbody.innerHTML = registerData.map((student, index) => `
            <tr>
				...
				<td style="width:290px; text-align:center; padding:4px;">\${student.email}</td>
				...
				<td style="width:130px; text-align:center; padding:4px;">\${student.specialization}</td>

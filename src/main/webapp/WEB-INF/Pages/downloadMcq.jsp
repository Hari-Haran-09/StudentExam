...
document.addEventListener("DOMContentLoaded", function() {
	...
	downloadBtn.addEventListener("click", async () => {
	    ...
	    // ✅ Add logo to top center if available
	    if (logoImg) {
	        doc.addImage(logoImg, "PNG", 80, 5, 50, 20); // (x, y, width, height)
	        y = 30; // move below logo
	    }
	    ...
	    questions.forEach((q) => {
	       ...
	       //doc.text(qText, 10, y);
	        ...
	        opts.forEach(opt => {
	            ...
	            // ✅ Optionally mark correct answer (you can remove this block if not needed)

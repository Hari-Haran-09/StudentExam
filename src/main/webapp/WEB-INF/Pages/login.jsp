...
<body>
	...
	<div class="div-img">
			...
			<div class="seb-download-section" style="text-align: center; margin: 20px 0; padding: 20px; border: 2px solid #28a745; border-radius: 10px; background: #f8fff8;">
			    <h4 style="color: #28a745; margin-bottom: 15px;">🔒 Secure Exam Browser Required</h4>
			    ...
			    <div class="instructions" style="text-align: left; margin-top: 20px; background: #e8f5e8; padding: 15px; border-radius: 5px;">
			        <h5 style="color: #2d5016; margin-bottom: 10px;">📋 How to Start Your Exam:</h5>
			        <ol style="color: #555; line-height: 1.6;">
			            <li><strong>Install</strong> <a href="https://safeexambrowser.org/download_en.html" target="_blank">Safe Exam Browser</a> (if not installed)</li>
						<li><strong>Download</strong> the configuration file above</li>
			            <li><strong>After download open the .seb file</li>
			            <li>The exam will open in <strong>secure, locked-down mode</strong></li>
			        </ol>
			        
			        <div style="background: #d1ecf1; padding: 10px; border-radius: 4px; margin-top: 10px;">
			            <strong>Note:</strong> The exam will only work when opened through Safe Exam Browser.
			        </div>
			    </div>
	<div class="parent1">
	...
	<script>
		document.getElementById("loginform").addEventListener("submit", function (e) {
								...
								const isSeb = navigator.userAgent.includes("SEB");
								    if (!isSeb) {
								        e.preventDefault();
								        alert("⚠️ Please open this exam using Safe Exam Browser.");
								    }
							    if (!confirmation) {
							        e.preventDefault();
							    }
